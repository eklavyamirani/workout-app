...
export function BalletSetup({ onComplete, onCancel }: BalletSetupProps) {
  ...
  // Available exercises not already in the list
  const availableToAdd = DEFAULT_BALLET_EXERCISES.filter(
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[80vh] overflow-y-auto">
              ...
              <div className="space-y-2">
                ...
                {availableToAdd.length === 0 && (
                  <p className="text-gray-500 text-sm text-center py-4">All exercises already added</p>
                )}
              </div>
            </div>
          </div>
